...
public class C0026x extends C0001b {
    public C0026x(CanBusServer canBusServer, Context context) {
    ...
    public void mo44l() {
        this.ej.on((byte) 0, new byte[]{(byte) 77, (byte) 101, (byte) 100, (byte) 105, (byte) 97}, 5);
    }
