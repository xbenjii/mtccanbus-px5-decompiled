...
public class an extends C0001b {
    byte[] aj;
    private boolean ak;

    public an(CanBusServer canBusServer, Context context) {
    ...
    public void mo35b(byte[] bArr, int i, int i2) {
        ...
        switch (bArr[i + 1]) {
            ...
            case (byte) 36:
                if (bArr[i + 2] == (byte) 2) {
                    dn(new byte[]{(byte) ((((((byte) (bArr[i + 3] & 128)) + ((byte) (bArr[i + 3] & 64))) + ((byte) (bArr[i + 3] & 32))) + ((byte) (bArr[i + 3] & 16))) + ((byte) (bArr[i + 3] & 8)))});
    ...
    public void mo37e() {
        ...
        this.ej.ob((byte) -126, new byte[]{(byte) 6}, 1);
    }
    ...
    public void mo39g() {
        this.ej.ob((byte) -64, new byte[]{(byte) 0, (byte) 32}, 2);
        this.ej.ob((byte) -126, new byte[]{(byte) 3}, 1);
    }

    public void mo40h(String str, int i) {
        this.ej.ob((byte) -64, new byte[]{(byte) 5, (byte) 64}, 2);
        this.ej.ob((byte) -126, new byte[]{(byte) 5}, 1);
    }
    ...
    public void mo43k(int i, int i2, byte b, int i3, int i4) {
        ...
        bArr[4] = (byte) -1;
        this.ej.ob((byte) -61, bArr, 6);
        this.ej.ob((byte) -126, new byte[]{(byte) 7}, 1);
    }

    public void mo44l() {
        this.ej.ob((byte) -64, new byte[]{(byte) 8, (byte) 32}, 2);
        this.ej.ob((byte) -126, new byte[]{(byte) 4}, 1);
    }
